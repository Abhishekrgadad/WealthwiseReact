...
const ScheduleForm = () => {
  ...
  const validate = () => {
    ...
    if (!formData.phone.trim()) {
      ...
      newErrors.phone =
        "Enter a valid phone number (numbers only, 10-15 digits).";
      valid = false;
    }
      ...
      <div className="max-w-4xl w-full mx-auto bg-gray-900 rounded-lg shadow-lg grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center p-8 md:p-12 border-b md:border-b-0 md:border-r border-gray-800">
          <h2 className="text-3xl font-bold text-white mb-4">
            Your ₹1 Crore Journey Starts With This <br></br>One Step
          </h2>
          <p className="text-lg text-gray-300 mb-6">
            Get expert, personalized investment guidance not just product sales.{" "}
            <br></br>
            Let us help you build long-term wealth through SIPs, insurance, PMS,
            and more.{" "}
          </p>
          <p className="text-lg text-gray-300 mb-6">
            No fees No pressure Just real advice.
          </p>
          <ul className="list-disc pl-5 text-gray-400 space-y-2 text-base">
            <li>Trusted by 10,000 investors across Karnataka & India</li>
