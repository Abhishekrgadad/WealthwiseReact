...
const Home = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-black flex items-start justify-center relative font-poppins pt-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <motion.h1
          initial={false}
          animate="visible"
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white leading-tight mb-4 sm:mb-6 text-left"
        >
          <motion.span
          variants={{
        ...
        <motion.p
          ...
          className="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed max-w-2xl text-left"
        >
